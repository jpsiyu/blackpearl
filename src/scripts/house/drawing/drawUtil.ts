...
export const drawWrapper = (ctx: CanvasRenderingContext2D, pos: IPos, callback: Function) => {
    ctx.save()
...
export const rectInCanvas = (ctx: CanvasRenderingContext2D, objPos: IPos, pos: IPos, objSize: number) => {
...
export const drawImageMid = (ctx: CanvasRenderingContext2D, midPos: IPos, image: CanvasImageSource, imageSize: number) => {
